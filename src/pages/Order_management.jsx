...
import schdules from "../data/schedule.json";
    ...
    return (
      <div className="order_card">
        ...
        <div className="order_info">
          <h3>{title}</h3>
          <p className="order_location">{subtitle}</p>
          <div className="order_actions">
            <button className="btn_pass" onClick={() => setIsModalOpen(true)}>
    ...
    return (
      <Link to="/TripBookingPage">
        <div className="recommended_card">
          <img
            src="./images/order_management/recommended1.png"
            alt="大稻埕貓路微章"
          />
  ...
  return (
    <main className="order_management_main">
      <h1 className="titleBox_h1">
        <img
          className="titleBox"
          src="./images/titlebox/order_management_titlebox.svg"
          alt="訂單管理Order Management"
        />
      </h1>


      <div
        className="hr_square_deco"
        style={{
          backgroundImage: 'url("./images/decorations/hr_square_deco.svg")',
        }}
      ></div>
          ...
          <div className="order_content_layout">
            <div className="order_list">
              {schdules.map((schdule) => (
                <Order_card {...schdule} key={schdule.id} />
              ))}
            </div>
            ...
            <div className="recommended_section">
              <h3>您可能也喜歡</h3>
              <div className="recommended_cards_container">
                <Recommended_card />
                <Recommended_card />
                <Recommended_card />
              </div>
      ...
      <div className="order_management_deco-box">
        <figure className="order_management_deco1">
          <img
            src="./images/decorations/deco-reading_teddy_bear.svg"
            alt="閱讀泰迪熊裝飾"
          />
        </figure>
      </div>
